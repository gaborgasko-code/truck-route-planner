/**
 * Truck Route Planner - inline SVG icon set.
 *
 * A small, consistent set of line icons (24 px grid, 1.75 px stroke) so the
 * UI never depends on emoji, which render differently on every platform.
 * Icons inherit `currentColor`, so context decides the colour.
 *
...
(function (global) {
  ...
  function svg(name, opts) {
    ...
    var cls = 'icon' + ((opts && opts.className) ? ' ' + opts.className : '');
  ...
  if (typeof module !== 'undefined' && module.exports) module.exports = TRP.icons;
