...
(function (global) {
  ...
  var STYLE = [
    ...
    'html,body{height:100%;margin:0;font:14px/1.45 "Segoe UI",Roboto,Helvetica,Arial,sans-serif;color:#0d1a2b}',
    '#map{position:absolute;inset:0}',
    '.hdr{position:absolute;top:0;left:0;right:0;height:44px;z-index:1200;background:linear-gradient(90deg,#114a86,#0b2b54);',
    'color:#fff;display:flex;align-items:center;gap:12px;padding:0 14px;box-shadow:0 2px 8px rgba(0,0,0,.28);',
    'border-bottom:2px solid #f2b73d}',
    '.hdr b{font-size:15px;letter-spacing:.3px}',
    '.hdr .by{margin-left:auto;font-size:12px;font-weight:700;color:#06182f;text-decoration:none;white-space:nowrap;',
    'background:linear-gradient(135deg,#ffd97a,#f2b73d 45%,#d99b1f);padding:4px 11px;border-radius:999px;',
    'box-shadow:0 4px 12px rgba(217,155,31,.45)}',
    '.hdr .by:hover{filter:saturate(1.1) brightness(1.04)}',
    '#map{top:44px}',
    '.pnl{background:rgba(255,255,255,.97);border:1px solid #dbe4ef;border-radius:10px;box-shadow:0 6px 20px rgba(10,40,80,.22);',
    'padding:10px 12px;max-width:290px;font-size:12.5px}',
    '.pnl h3{margin:0 0 6px;font-size:13px;color:#114a86;text-transform:uppercase;letter-spacing:.6px}',
    '.kv{display:flex;justify-content:space-between;gap:10px;padding:2px 0;border-bottom:1px dotted #dbe4ef}',
    '.kv:last-of-type{border-bottom:0}',
    '.kv b{color:#0d1a2b}',
    '.tot{background:#fff6e3;border-radius:6px;padding:4px 6px;margin-top:4px;border:1px solid #ffe3a6}',
    'table{width:100%;border-collapse:collapse;margin-top:8px;font-size:12px}',
    'th,td{padding:3px 4px;text-align:left;border-bottom:1px solid #edf2f8}',
    'th{color:#5a6b85;font-weight:600}',
    '.num{text-align:right;font-variant-numeric:tabular-nums}',
    '.reg{max-height:52vh;overflow:auto}',
    '.reg h4{margin:8px 0 3px;font-size:12.5px;color:#114a86}',
    '.reg ul{margin:0;padding-left:16px}',
    '.reg li{margin-bottom:3px}',
    '.tgl{width:100%;border:0;background:#114a86;color:#fff;border-radius:6px;padding:6px 8px;font-weight:600;',
    'cursor:pointer;display:flex;justify-content:space-between;align-items:center;font-size:12.5px}',
    '.warn{margin-top:8px;background:#fff6e3;border-left:3px solid #f2b73d;padding:6px 8px;border-radius:4px;font-size:11.5px}',
    '.foot{margin-top:8px;font-size:11px;color:#5a6b85;text-align:right}',
    ...
    '.mk-a{background:#11855a}.mk-b{background:#c0392f}.mk-s{background:#f2b73d;color:#0d1a2b}',
    '.mk-p{background:#5a6b85;font-size:11px}.mk-ps{background:#114a86;font-size:11px}',
  ...
  var SCRIPT = [
    ...
    'L.polyline(D.coords,{color:"#f2b73d",weight:11,opacity:.85,lineCap:"round"}).addTo(map);',
    'L.polyline(D.coords,{color:"#114a86",weight:5,opacity:.95,lineCap:"round"}).addTo(map);',
